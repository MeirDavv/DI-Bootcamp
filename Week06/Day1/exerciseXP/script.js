...
(function (numberOfCildren = 4, partnerName = 'Lia', geographicLocation = 'TLV', jobTitle = 'fullstack developer') {
...
function makeJuice(sizeOfBeverage){
    ...
    addIngredients('Moka','Matcha','Coffee');
    addIngredients('Coke','Sugar','Almond');
    displayJuice();
